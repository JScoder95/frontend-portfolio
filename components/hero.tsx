...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const roles = ["Front-end Developer", "UX Engineer", "React.js Expert", "TypeScript Developer"]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              <span className="gradient-text">Creative</span> & <span className="gradient-text">Passionate</span>
            </h1>

            <h2 className="text-3xl md:text-4xl font-bold mb-6 h-12">
              <span ref={typingRef} className="border-r-2 border-primary"></span>
            </h2>

            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0">
              Specialized in creating exceptional digital experiences with modern web technologies. Turning complex
